        ...
        <div className='text-green-600 font-bold mb-52'>
            <div className='w-[320px] md:w-[500px] mx-auto'>
                <form onSubmit={handleOnSubmit}>
                    ...
                    <input onChange={handleNameInput} ref={nameRef} type="text" name="userName" id="userName" placeholder='Your Name' autoComplete='off' required />
                    ...
                    <input onChange={handleImgUrl} type="text" name="imgUrl" id="imgUrl2" placeholder='Your image url (optional)' autoComplete='off' />
                    <div>
                        <input onClick={() => setAgree(!agree)} type="checkbox" name="checkbox" id="terms" />
                        <label htmlFor="terms">Accept bookMart all terms and conditions</label>
                    </div>
                    <input disabled={!agree} title={!agree ? 'Accept bookMart all terms and conditions' : ''} type="submit" value="Register" />
                </form>
            </div>
        </div>
    );
